...
Сразу скажу, что *GUI* - это приложение с графическим интерфейсом, т.е. те которыми вы чаще всего пользуетесь<br>
Исходя из выше сказано, пержде чем переходить к работе с Git, нужно понять как работать с консолью
