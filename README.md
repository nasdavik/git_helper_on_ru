...
При установке, достаточно будет просто оставить все по умолчанию. Если вы счастливый обладатель Windows, то для открытия Bash будет достаточно нажать ПКМ в любой папке и в выскачивающем поле возможностей вы увидите пункт __Open Git bash here__
